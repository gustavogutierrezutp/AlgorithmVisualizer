...
3. Menu de operaciones. En este lugar se encuentran de manera agrupada por
...
- Opciones de visualización. Permiten al usuario alterar algunas características
  de la visualización de la estructura de datos. Estas opciones son útilies para
  la presentación y visualización de la estructura de datos en entornos de
  estudio o de docencia.



A continuación describiremos cada una de las partes 
