...
diferente (ver @tip-cambiar-color). La @fig-insert_at_head_before muestra el
lienzo antes de la inserción. Finalmente la @fig-insert_at_head_after muestra el
lienzo después de la inserción.

::: {#fig-insert_at_head_before}
![](figures/insert-head-before.png)

Vista anterior a la inserción del valor $25$ al inicio de la lista.
:::

::: {#fig-insert_at_head_after}
![](figures/insert-head-after.png)

Vista posterior a la inserción del valor $25$ al inicio de la lista.
:::
...
![](figures/additional-pointers.png)
