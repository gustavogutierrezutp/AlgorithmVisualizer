...
- Gestionar las 18 variables de estado (ver @sec-gestion-estado).
- Coordinar los tres _custom hooks_ (`useListOperations`,
  `useListVisualization`, `useListInitialization`).
- Definir los 22 manejadores de eventos que conectan el menú con las
  operaciones.
